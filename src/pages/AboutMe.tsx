    ...
    return (
        <div id="pagina" className="mx-30">
            <div id="resumo" className="flex justify-center w-full h-1/2 mb-20">
                ...
                <div className="flex-col w-1/3 space-4">
                    <p className="mb-6 text-justify">
                        Olá! Sou João Paulo, um cientista da computação com conhecimentos abrangendo diversas áreas da computação, como desenvolvimento de software, ciência de dados, inteligência artificial e cibersegurança.
                        Tenho experiência em todas as etapas do desenvolvimento de software moderno, desde algoritmos à implantação. Sou dedicado e apaixonado por criar soluções de alta qualidade que gerem grande valor real. <br></br>
                        Embora a maior parte da minha experiência seja em desenvolvimento web, sou motivado por funções que combinam resolução de problemas, dados, segurança e criatividade.&nbsp;
                        <Link to={"/portfolio"} className='text-blue-400'>Meus projetos acadêmicos e pessoais</Link> abrangem uma ampla gama de tecnologias modernas. 
                        Também adoro colaborar em equipes dinâmicas, sempre buscando causar um impacto positivo e crescer profissionalmente.
                    </p>
            ...
            <section id="whatido" className="">
                ...
                <div className="grid w-auto h-auto grid-cols-2 place-content-stretch gap-x-20 gap-y-8 mx-6 my-2">
